...
exports.createPdf = async (req, res, next) => {
  ...
  let total = 0,
    totlatax = 0,
    totalwithtax = 0,sgst=0,cgst=0,igst=0;
  ...
  let htmlData = `<!DOCTYPE html>
    ...
    <body>
        <div>
            <table class="header">
                <tr>
                    ...
                    <td class="fromInvoice">
                        ...
                        <p>Mobile: ${headerInfo.phoneNumber}; Website:www.seva-u.com</p>
            ...
            <div class="itemList">
                ...
                ${productsHeader}
                 ${productsDetails}
                    ...
                    <tr>
                        <td class="totalAmountBottom" colspan="${igstfound?6:7}" style="text-align: right;font-weight: bold;">
                            Total Amount
                        </td>
                        ...
                        ${!igstfound ? ` <td style="font-weight:bold">
                        ${sgst}
                    </td>`:'' }
            ...
            <p style="margin:20px;font-weight: bold;">Total Amount in Words: ${valueInWords(Math.round(totalwithtax))}</p>
            ...
            <p style="margin:20px;font-weight: bold;">${headerInfo.invoiceHeader}</p>
